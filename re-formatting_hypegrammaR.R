...
wide_table<-function(x){ 
  x[x=="NA"]<-NA
  if (!(is.na(x["independent.var"])) && !(is.na(x["repeat.var.value"]))){                                                                                                   #for area and settlement levels
    ...
    if ((is.na(x["independent.var"])) && (is.na(x["repeat.var.value"]))){                                                                                                   #for national level
